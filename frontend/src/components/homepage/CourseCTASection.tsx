    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex flex-col-reverse md:flex-row items-center gap-12">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h2
            className={`text-3xl md:text-4xl font-bold text-slate-900 mb-4 ${robotoSlab.className}`}
          >
            We are Always Ensure
            <br />
            Best Course for your learning
          </h2>
          <p className={`text-gray-600 mb-6 ${poppins.className}`}>
            Lorem Ipsum is simply dummy text of the printing and IT typesetting
