...
export default function FeaturesSection() {
  return (
    <motion.section
      id="features"
      className="bg-[#F9FAFC] py-16 text-center"
    ...
    >
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className={`text-4xl font-bold text-sky-900 mb-4 ${karma.className}`}>
          Benefits of Online Education
        </h2>
        <p className={`text-gray-600 mb-12 max-w-2xl mx-auto ${poppins.className}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {benefits.map((item, index) => (
            ...
            >
              ...
              <h3 className={`text-lg font-semibold text-slate-900 mb-2 ${karma.className}`}>
                {item.title}
              </h3>
