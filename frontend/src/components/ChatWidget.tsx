...
export default function ChatWidget() {
  ...
  >
    {/* Chat Panel with Animation (placed before button so it's above visually) */}
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="absolute bottom-full mb-4 w-80 h-96 bg-white shadow-2xl rounded-xl flex flex-col overflow-hidden border border-gray-200"
        >
          {/* Header */}
    ...
    <button
      ...
      className="bg-blue-600 hover:bg-blue-700 transition-colors text-white p-4 rounded-full shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-300"
    >
      💬
    </button>
  </div>
