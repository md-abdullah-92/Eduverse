  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-yellow-50 to-yellow-100 relative overflow-hidden">
      ...
      <main className="ml-20 p-5 flex-1">
        <div
          className={`min-h-screen bg-gradient-to-b from-white to-blue-50 pb-20 ${poppins.className}`}
        >
          {/* Banner */}
          ...
          <div className="max-w-7xl mx-auto px-4 mt-8">
            <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-600">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <div>
                  <h2
                    className={`text-xl font-bold text-gray-800 ${playfair.className}`}
                  >
                    Instructor Dashboard
                  </h2>
                  <p className="text-gray-600">
                    Access your instructor dashboard to view analytics and
                    manage your courses.
                  </p>
                </div>
                <a
          ...
          <div className="max-w-7xl mx-auto px-4 mt-12">
            <div className="flex justify-between items-center mb-8">
              <h2
                className={`text-2xl font-bold text-gray-800 ${dmSerif.className}`}
              >
