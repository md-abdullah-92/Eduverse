...
export default function StudentEnrolledCoursesPage({
  ...
  if (loading) {
  return (
    <div className={`min-h-screen bg-gradient-to-b from-white to-teal-50 flex items-center justify-center flex-col ${poppins.className}`}>
...
return (
  <div className={`min-h-screen bg-gradient-to-b from-white to-teal-50 pb-20 ${poppins.className}`}>
    {/* Banner */}
    <div className="bg-gradient-to-r from-teal-700 to-purple-600 text-white py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div>
            <h1 className={`text-4xl md:text-5xl font-bold mb-4 ${raleway.className}`}>
              Enrolled Courses
            </h1>
    ...
    <div className="max-w-7xl mx-auto px-4 mt-8">
      <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-600">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div>
            <h2 className={`text-xl font-bold text-gray-800 ${raleway.className}`}>
              Student Dashboard
            </h2>
    ...
    <div className="max-w-7xl mx-auto px-4 mt-12">
      <div className="flex justify-between items-center mb-8">
        <h2 className={`text-2xl font-bold text-gray-800 ${raleway.className}`}>
      ...
      {filteredCourses.length === 0 ? (
        <div className="text-center py-16">
          ...
          <h3 className={`text-2xl font-semibold text-gray-700 ${raleway.className}`}>
            No enrolled courses found
          </h3>
          <p className="text-gray-500 mt-2">
            Try adjusting your search or filter criteria, or enroll in new courses
          </p>
          <Link
