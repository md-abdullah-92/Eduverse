...
import { playfair, poppins, raleway } from "@/utils/font";
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 flex items-center justify-center flex-col">
        <LoadingIndicator />
        <p
          className={`text-xl ${poppins.className} font-semibold text-gray-700`}
        >
          ...
          <div className="max-w-7xl mx-auto px-4 py-14">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-center md:text-left">
                ...
                <p
                  className={`text-purple-100 text-lg max-w-xl ${raleway.className}`}
                >
                  {getSubtitle()}
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 mt-12">
          ...
          {filteredCourses.length === 0 ? (
            <div className="text-center py-16 bg-gray-50 rounded-lg p-8">
              <h3
                className={`text-xl font-semibold text-gray-700 ${poppins.className}`}
              >
                No courses found
              </h3>
        ...
        {!isLoggedIn && (
          <div className="max-w-7xl mx-auto px-4 mt-16">
            <div className="bg-gradient-to-r from-teal-50 to-purple-50 border border-teal-200 rounded-xl p-8 text-center">
              <h3
                className={`text-2xl font-bold text-gray-800 mb-4 ${playfair.className}`}
              >
                Ready to Start Learning?
              </h3>
              <p
                className={`text-gray-600 mb-6 max-w-2xl mx-auto ${raleway.className}`}
              >
