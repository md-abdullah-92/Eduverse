...
export default function AboutPage() {
  return (
    <div>
      {/* Main container */}
      <div
        className={`min-h-screen bg-[#0F4C5C] text-white px-6 py-16 ${raleway.className}`}
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg text-center text-gray-300 mb-12">
            ...
            reshaping modern learning through intelligent technology and accessible design.
          </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-200 leading-relaxed">
              ...
              real-time interactivity, and scalable cloud architecture. EduVerse aspires
              to empower individuals by providing personalized, flexible, and enriching
              educational experiences tailored to diverse learning needs.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-200 leading-relaxed">
              We envision a global learning environment where barriers to education
              no longer exist — a space where every student, regardless of background
              or location, has the opportunity to grow through intelligent and engaging
              learning systems.
            </p>
          </section>
